...
const Footer = () => {
  ...
  return <footer className="bg-muted/10 py-10">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4">
            {["GitHub", "Twitter", "LinkedIn"].map(item => <Button key={item} variant="ghost" size="sm" className="text-muted-foreground hover:text-primary transition-all duration-300 magnetic-hover click-ripple">
                {item}
              </Button>)}
          </div>
        </div>
        ...
        <div className="mt-8 pt-4 border-t border-muted text-center text-sm text-muted-foreground">
          ...
          <p className="mt-2 animate-pulse">
            ...
            <span className="inline-block mx-1 text-red-500 animate-pulse" style={{
            animationDelay: '0.5s'
          }}>❤️</span>
